...
export class CpvcDoubleNailClampComponent implements OnInit, AfterViewInit {
  ...
  ngOnInit() {
    ...
    this.meta.addTags([
      ...
      { name: 'canonical', content: 'https://edlerclamp.com/products/cpvc-double-nail-clamp' },
      ...
      { property: 'og:image', content: 'https://edlerclamp.com/assets/products/cpvc-double-nail-clamp.jpg' },
      { property: 'og:url', content: 'https://edlerclamp.com/products/cpvc-double-nail-clamp' },
      ...
      { name: 'twitter:image', content: 'https://edlerclamp.com/assets/products/cpvc-double-nail-clamp.jpg' }
    ]);
  ...
  private addProductSchema() {
    ...
    script.text = JSON.stringify({
      ...
      "image": "https://edlerclamp.com/assets/products/cpvc-double-nail-clamp.jpg",
