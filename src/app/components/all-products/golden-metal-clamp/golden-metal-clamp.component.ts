...
export class GoldenMetalClampComponent implements OnInit, AfterViewInit {
  ...
  ngOnInit() {
    ...
    this.meta.addTags([
      ...
      { property: 'og:url', content: 'https://edlerclamp.com/products/golden-metal-clamp' },
      ...
      { name: 'twitter:image', content: 'https://edlerclamp.com/assets/products/golden-metal-clamp.jpg' }
    ]);
  ...
  private addProductSchema() {
    ...
    const productSchema = {
      ...
      "image": "https://edlerclamp.com/assets/products/golden-metal-clamp.jpg",
