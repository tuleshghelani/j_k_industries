...
export class CpvcConcealedValveComponent implements OnInit, AfterViewInit {
  ...
  ngOnInit() {
    ...
    this.meta.addTags([
      ...
      { property: 'og:image', content: 'https://www.jkindustriesrajkot.com/assets/products/cpvc-concealed-valve.png' },
      { property: 'og:url', content: 'https://www.jkindustriesrajkot.com/products/cpvc-concealed-valve' },
      ...
      { name: 'twitter:image', content: 'https://www.jkindustriesrajkot.com/assets/products/cpvc-concealed-valve.png' }
    ]);
  ...
  private addProductSchema() {
    ...
    const productSchema = {
      ...
      "offers": {
        "@type": "Offer",
        "url": "https://www.jkindustriesrajkot.com/products/cpvc-concealed-valve",
        "priceCurrency": "INR",
