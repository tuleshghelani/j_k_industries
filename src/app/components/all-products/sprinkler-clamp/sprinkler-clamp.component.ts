...
export class SprinklerClampComponent implements OnInit, AfterViewInit {
  ...
  ngOnInit() {
    ...
    this.meta.addTags([
      ...
      { property: 'og:image', content: 'https://www.jkindustriesrajkot.com/assets/products/sprinkler-clamp.jpg' },
      { property: 'og:url', content: 'https://www.jkindustriesrajkot.com/products/sprinkler-clamp' },
      ...
      { name: 'twitter:image', content: 'https://www.jkindustriesrajkot.com/assets/products/sprinkler-clamp.jpg' }
    ]);
  ...
  private addProductSchema() {
    ...
    const productSchema = {
      ...
      "image": "https://www.jkindustriesrajkot.com/assets/products/sprinkler-clamp.jpg",
      ...
      "offers": {
        "@type": "Offer",
        "url": "https://www.jkindustriesrajkot.com/products/sprinkler-clamp",
        "priceCurrency": "INR",
