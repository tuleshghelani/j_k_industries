...
export class StepClampComponent implements OnInit, AfterViewInit {
  ...
  ngOnInit() {
    ...
    this.meta.addTags([
      ...
      { property: 'og:image', content: 'https://www.jkindustriesrajkot.com/assets/products/step-clamp.jpg' },
      { property: 'og:url', content: 'https://www.jkindustriesrajkot.com/products/step-clamp' },
      ...
      { name: 'twitter:image', content: 'https://www.jkindustriesrajkot.com/assets/products/step-clamp.jpg' }
    ]);
  ...
  private addProductSchema() {
    ...
    const productSchema = {
      ...
      "image": "https://www.jkindustriesrajkot.com/assets/products/step-clamp.jpg",
      ...
      "offers": {
        "@type": "Offer",
        "url": "https://www.jkindustriesrajkot.com/products/step-clamp",
        "priceCurrency": "INR",
